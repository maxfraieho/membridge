...
This file provides global guidance to Claude Code for working with any codebase.
...
Never kill node.exe -- claude code is a node app.
...
|----|------|---|-------|------|
| #261 | 1:59 PM | 🔵 | Claude hooks directory exists for custom lifecycle scripts | ~309 |
</claude-mem-context>